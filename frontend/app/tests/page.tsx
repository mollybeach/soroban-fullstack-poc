...
import { TestsSectionNav } from "@/components/TestsSectionNav";
    ...
    <div className="space-y-8 pb-12">
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-md sm:p-10">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          ...
          <aside className="flex w-full shrink-0 flex-col gap-4 sm:max-w-xs lg:w-60 xl:w-64">
            <div
              className={`flex items-center justify-center gap-2 rounded-full border px-4 py-2 text-sm font-semibold shadow-sm ${
                d.success
            ...
            <TestsSectionNav className="rounded-2xl border border-slate-200 bg-slate-50/80 p-3 shadow-inner" />
          </aside>
        </div>
      </div>
